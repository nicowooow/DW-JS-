...
salida_7.innerHTML=calculas(calculas(calculas(calculas(calculas(2,2,'multiplicar')),3,'sumar'),7,'sumar'),2,'dividir')  + " <<<<< calculas(calculas(calculas(calculas(calculas(2,2,'multiplicar')),3,'sumar'),7,'sumar'),2,'dividir') "
